...
vim.o.showmode = false -- We always need to see things like -- INSERT -- anymore
...
vim.o.timeoutlen = O.timeoutlen -- By default timeoutlen is 1000 ms, now set to 100, I think
...
-- CHECK: if I actually want to use smartcase
vim.o.smartcase = false

-- setting personal prefs
vim.cmd('set foldlevel=3')
vim.cmd('set noequalalways')
vim.cmd('set ignorecase')
vim.cmd('set winminheight=0')

vim.cmd('set colorcolumn=80') -- fixed for now, but  NOTE:-bug required having that 'set colorcolumn=99999'
